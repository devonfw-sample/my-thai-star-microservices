...
The default integration for a handler is _lambda_. See https://github.com/devonfw/devon4node/wiki[devon4node documentation] for more information about default values and how to change it.
[NOTE]
====
